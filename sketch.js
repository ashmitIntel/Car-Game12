...
function setup() {
  ...
  Scooter = createSprite(200,350,100,100);
  Scooter.addImage(ScooterImage);
  Scooter.scale = 0.4;
  Scooter.setCollider("rectangle",0,0);
  Scooter.debug = false;
...
Scooter.x = Scooter.x+5; 
 ...
 if(coinGroup.isTouching(Scooter)){
  score = score + 1
  coinGroup.destroyEach();
    ...
    if(drumGroup.isTouching(Scooter) || obstacleGroup.isTouching(Scooter)){
  Scooter.destroy();
